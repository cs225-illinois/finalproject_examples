...
## Communication
1. **Team Meetings** Our team will meet once a week every Tuesday from 5-7 PM using Zoom. Each member will rotate being the designated note-taker, starting with rittika2. Notes will be stored on a Google document, time-stamped for each meeting. The note-taker is also responsible for drafting the weekly DEVELOPMENT LOG entry, which is approved by the team at the start of the following week’s meeting.
...
Brad Solomon (bradsol)
G Carl Evans (gcevans)
Lee Thaxor (lh1)
Bob Ross (bross2)